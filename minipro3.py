...
def main():
    data_instrumen = [
        ("Guitar", "Fender", "String", 500.000, 10),
        ("Keyboard", "Yamaha", "Piano", 800.000, 5),
        ("Drums", "Pearl", "Percussion", 1200.000, 3),
        ("Violin", "Stradivarius", "String", 1500.000, 7),
        ("Trumpet", "Yamaha", "Brass", 700.000, 8),
    ]
